...
from ..models import UploadResponse, PaperSummary
...
async def get_session(session_id: str):
    ...
    # Re-seed in-memory chat session if it was evicted (e.g. after restart)
...
async def upload_paper(file: UploadFile = File(...)):
    ...
    session_store.create(session_id, h, summary.title, summary.abstract, paper_text)
